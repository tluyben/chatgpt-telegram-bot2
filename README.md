...
- [x] (NEW!) Support _new models_ [announced on June 13, 2023](https://openai.com/blog/function-calling-and-other-api-updates)
- [x] (NEW!) Support _functions_ (plugins) to extend the bot's functionality with 3rd party services
...
As described here; https://github.com/wrxck/telegram-bot-lua/issues/4

you need to instruct the BotFather to remove the privacy setting from your both to listen to all text + transcribe audio etc.
